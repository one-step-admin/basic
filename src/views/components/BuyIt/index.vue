...
onMounted(() => {
    ...
    setTimeout(() => {
        proxy.$notify({
            ...
            dangerouslyUseHTMLString: true,
            message: `
                <p>只需给项目仓库点⭐，原价 696 元的专业版只需 <b style="color: rgb(255, 68, 0); font-size: 18px;">496</b> 元，点<a href="https://hooray.${location.origin.includes('gitee') ? 'gitee' : 'github'}.io/fantastic-admin-discovery/buy" target="_blank"><b>这里</b></a>了解一下。</p>
